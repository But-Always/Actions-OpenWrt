...
git clone https://github.com/Ameykyl/luci-app-koolproxyR package package/openwrt-packages
git clone https://github.com/rosywrt/luci-theme-rosy package package/openwrt-packages
